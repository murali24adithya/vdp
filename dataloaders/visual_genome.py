...
from config import VG_IMAGES, IM_DATA_FN, VG_SGG_FN, VG_SGG_DICT_FN, BOX_SCALE, IM_SCALE, PROPOSAL_FN, CUSTOM_SGG_FN, CUSTOM_SGG_DICT_FN, CUSTOM_DATA_FN, EVAL_CUSTOM, CUSTOM_IMAGES
...
class Custom(Dataset):
    def __init__(self, mode, roidb_file=CUSTOM_SGG_FN, dict_file=CUSTOM_SGG_DICT_FN,
        ...
        # print(self.split_mask[:10])
        self.filenames = load_image_filenames(image_file, image_dir=CUSTOM_IMAGES)
        # print("EVAL_CUSTOM", EVAL_CUSTOM)
        if not EVAL_CUSTOM:
...
class VG(Dataset):
    def __init__(self, mode, roidb_file=VG_SGG_FN, dict_file=VG_SGG_DICT_FN,
        ...
        self.filenames = load_image_filenames(image_file, image_dir=VG_IMAGES, corrupted_ims=['1592.jpg', '1722.jpg', '4616.jpg', '4617.jpg'])
        self.filenames = [self.filenames[i] for i in np.where(self.split_mask)[0]]
...
def load_image_filenames(image_file, image_dir, corrupted_ims = []):
    """
